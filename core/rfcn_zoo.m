function net = rfcn_zoo(modelName)
%RFCN_ZOO - load detector by name
%  RFCN_ZOO(MODELNAME) - loads a detector by its given name. 
...
% All rights reserved.
  ...
  modelNames = {
    ...
    'rfcn-res101-pascal', ...
    'rfcn-res101-coco', ...
    'rfcn-res50-pascal-local', ...   % trained locally with caffe
    'rfcn-res50-pascal-ohem-local', ...
  } ;
  ...
  while waiting
    ...
    switch str
      case 'y'
        ...
        baseUrl = 'http://www.robots.ox.ac.uk/~albanie/models/r-fcn' ;
